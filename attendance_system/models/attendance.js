...
module.exports.updateAttendance = function(school, subject_id, lecture_timestamp_old, students_present, students_absent, students_notapplicable, duration_of_class, callback){
  for(var i=0 ; i<students_present.length ; ++i){
